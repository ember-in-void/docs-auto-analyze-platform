          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-surface border border-white/10 rounded-xl pl-4 pr-12 py-3.5 text-white text-sm focus:border-electric outline-none transition-colors"
                placeholder="••••••••"
                required
                minLength={6}
              />
